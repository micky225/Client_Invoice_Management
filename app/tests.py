...
class ApiResponseTimeTests(TestCase):
    def setUp(self):
        self.client = Client()
        self.api_invoice_list_create_url = reverse('app:api_invoice_list_create')
        self.api_invoice_upload_csv_url = reverse('app:api_invoice_upload_csv')
